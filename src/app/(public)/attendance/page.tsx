...
export default function AttendancePage() {
  ...
  return (
    <div className="mt-300 flex flex-col gap-6 px-450">
      ...
      {/* 모달 1: QR 출석 모달 (overline + title + description + footer description) */}
      <Dialog open={qrModalOpen} onOpenChange={setQrModalOpen}>
        <DialogContent>
          ...
          <DialogFooter description="모바일에서는 QR코드를 카메라로 스캔할 수 있어요.">
            <Button variant="primary" size="lg" onClick={() => setQrModalOpen(false)}>
              출석 확인하기
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      {/* 모달 3: 페이지네이션 모달 */}
      <Dialog open={paginationModalOpen} onOpenChange={setPaginationModalOpen}>
        <DialogContent>
          <DialogHeader overline="출석 기록" title="7월 출석 현황" />
          <DialogBody>
            <div className="flex flex-col gap-300">
