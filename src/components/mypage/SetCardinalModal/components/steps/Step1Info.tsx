...
function Step1Info() {
  return (
    <div className="p-400">
      <div className="bg-container-neutral-alternative flex flex-col items-center gap-300 rounded-md p-300">
        ...
        <div className="flex flex-col gap-200">
          <p className="typo-sub3 text-brand-primary flex flex-col items-center gap-200 text-center">
            설정 전 확인해 주세요
          </p>
