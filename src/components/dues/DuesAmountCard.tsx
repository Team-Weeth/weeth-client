...
function DuesAmountCard({ cardinalNumber, amount, children, className }: DuesAmountCardProps) {
  return (
    <section className={cn('bg-container-neutral flex flex-col rounded-lg p-450', className)}>
      <div className="flex flex-col gap-100">
        <span className="typo-caption1 text-text-alternative">{cardinalNumber}기 회비</span>
