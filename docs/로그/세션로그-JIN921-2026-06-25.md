...
- 총 회비 설정 온보딩 5단계 중 3단계까지 구현 (Step 1~3)
...
- [ ] **Step 3 검수** — Figma 대비 디테일 확인 (카드 패딩, 라디오 버튼 크기 등)
- [ ] **이전 버튼 스타일 수정** — `PrevButton`이 현재 `bg-button-primary`(teal) 사용 중. 디자인에서는 neutral(outline) 스타일. 수정 필요
